...
🎯 **Prepping for 2026 AI 秋招 (campus recruiting)?** → [**ARIS-in-AI-Offer**](https://github.com/wanshuiyin/ARIS-in-AI-Offer) ([English README](https://github.com/wanshuiyin/ARIS-in-AI-Offer/blob/main/README_EN.md)) · a curated collection of long-form Chinese ML / LLM / Multimodal / Generative-Model interview cheat sheets — formula derivations + from-scratch PyTorch + 25 high-frequency Q&A (L1/L2/L3) per topic — auto-generated by ARIS's `/render-html` workflow. **希望大家秋招轻松一点 🌱**
